...
public class MyListsPageObject extends MainPageObject {
    ...
    private static final String
            OVERLAY_IN_MY_LIST = "org.wikipedia:id/negativeButton",
    ...
    public void closeOverlayMessage() {
        this.waitForElementAndClick(
                By.id(OVERLAY_IN_MY_LIST),
    ...
    public void clickArticleTitleInMyList(String article_title) {
        String search_result_xpath = getSaveArticleXpathByTitle(article_title);
        this.waitForElementAndClick(By.xpath(search_result_xpath), "Cannot find and click title with substring " + article_title, 10);
    }
}